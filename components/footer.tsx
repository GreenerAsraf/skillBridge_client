...
export default function Footer() {
  return (
    <footer className='relative border-t border-border bg-card dark:bg-slate-950 text-muted-foreground overflow-hidden'>
      ...
      <div className='mx-auto max-w-6xl px-6 py-12 relative z-10'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8 mb-10'>
            ...
            <div className='flex items-center gap-3 pt-2'>
              {[
                ...
                <a
                  key={idx}
                  href={social.href}
                  className='h-8 w-8 rounded-lg bg-muted border border-border flex items-center justify-center text-muted-foreground hover:text-emerald-500 dark:hover:text-emerald-400 hover:border-emerald-500/20 hover:bg-muted/80 transition-all duration-200'
                >
                  {social.icon}
                </a>
              ))}
          ...
          {/* Links 1 */}
          <div>
            <h4 className='text-sm font-bold text-foreground mb-4 tracking-wider uppercase'>Platform</h4>
            <ul className='space-y-2.5 text-xs font-light'>
              <li>
                <Link href='/tutors' className='hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors'>Browse Tutors</Link>
              </li>
              <li>
                <Link href='/register' className='hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors'>Become a Tutor</Link>
              </li>
              <li>
                <Link href='/login' className='hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors'>Student Login</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Links 2 */}
          <div>
            <h4 className='text-sm font-bold text-foreground mb-4 tracking-wider uppercase'>Company</h4>
            <ul className='space-y-2.5 text-xs font-light'>
              <li>
                <Link href='/about' className='hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors'>About Us</Link>
              </li>
              <li>
                <Link href='/contact' className='hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors'>Contact Us</Link>
              </li>
              <li>
                <a href='#' className='hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors'>Privacy Policy</a>
              </li>
            </ul>
          </div>
